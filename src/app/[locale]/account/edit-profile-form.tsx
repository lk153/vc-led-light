...
export default function EditProfileForm({
  ...
  const valueClass = "text-slate-900 font-medium text-lg";
  const inputClass =
    "w-full px-3 py-2 border border-slate-200 rounded-lg text-lg font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary";
