...
const statusConfig = {
  delivered: { icon: "check_circle", color: "text-green-500" },
  shipped: { icon: "local_shipping", color: "text-primary" },
  processing: { icon: "pending", color: "text-orange-500" },
};
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        ...
                        >
                          ...
                          <span
                            ...
                            style={{ transform: expandedOrder === order.id ? "rotate(180deg)" : undefined }}
                          >
                            expand_more
                          </span>
                        </button>
